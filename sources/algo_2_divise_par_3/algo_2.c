...
/*   Updated: 2021/08/07 18:58:39 by rsanchez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	sort_b2(t_swap *swap, int size_group)
{
	int	dir;
	int	index;
...
void    sort_a2(t_swap *swap, int size_group)
{
	...
	//	display_stacks(swap);
	if (size_group > 20)
		sort_b2(swap, size_group / 2);
	else
		final_from_b(swap);
}

static void    pre_sort_a2(t_swap *swap, int size_group)
{
	int	dir;
	int	index;
...
{
//	if (!(swap->do_display))
//		test_algo2(swap, swap->numbers, swap->total_size / 25, swap->total_size / 5);
//	else
//	{

		pre_sort_a2(swap, swap->total_size);
//	}
}
